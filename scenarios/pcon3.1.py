...
def run():
    ...
    Nfdc.setStrategy(ndn.net["r1"], "/A", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r1"], "/B", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r1"], "/C", "PCON/%FD%01")
    
    Nfdc.setStrategy(ndn.net["r2"], "/A", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r2"], "/B", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r2"], "/C", "PCON/%FD%01")
    
    Nfdc.setStrategy(ndn.net["r3"], "/A", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r3"], "/B", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r3"], "/C", "PCON/%FD%01")
    
    Nfdc.setStrategy(ndn.net["r4"], "/A", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r4"], "/B", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r4"], "/C", "PCON/%FD%01")
    
    Nfdc.setStrategy(ndn.net["r5"], "/A", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r5"], "/B", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r5"], "/C", "PCON/%FD%01")
    
    Nfdc.setStrategy(ndn.net["r6"], "/A", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r6"], "/B", "PCON/%FD%01")
    Nfdc.setStrategy(ndn.net["r6"], "/C", "PCON/%FD%01")
    ...
    ping1 = getPopen(
        ndn.net["c1"],
        f"pcon-client --prefix /A --timingStop 320000",
    ...
    # getPopen(
    #     ndn.net["c2"],
    #     f"pcon-client --prefix /B --timingStop 320000 --delayStart 20000 --initialWindowSize 20",
    #     stdout=qsccp_client_log,
    #     stderr=qsccp_client_log,
    # )
    ...
    # getPopen(
    #     ndn.net["c3"],
    #     f"pcon-client --prefix /C --timingStop 320000 --delayStart 160000 --delayGreedy 240000 --greedyRate 10000000 --initialWindowSize 20",
    #     stdout=qsccp_client_log,
    #     stderr=qsccp_client_log,
    # )
    ping1.wait()
