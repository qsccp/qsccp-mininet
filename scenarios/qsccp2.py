...
def run():
    ...
    addRoute(ndn, "r1", "r3", "/A")
    addRoute(ndn, "r1", "r3", "/B")
    addRoute(ndn, "r1", "r3", "/C")
    
    addRoute(ndn, "r2", "p1", "/A")
    addRoute(ndn, "r2", "p1", "/B")
    addRoute(ndn, "r2", "p1", "/C")
    addRoute(ndn, "r3", "p2", "/A")
    addRoute(ndn, "r3", "p3", "/B")
    addRoute(ndn, "r3", "p4", "/C")
    ...
    ping1 = getPopen(
        ndn.net["c1"],
        f"qsccp-client --prefix /A --timingStop 90000 --tos 5 --initialSendRate 50000",
    ...
    ping1 = getPopen(
        ndn.net["c2"],
        f"qsccp-client --prefix /B --timingStop 120000 --delayStart 30000 --tos 6 --initialSendRate 50000",
        stdout=qsccp_client_log,
        stderr=qsccp_client_log,
    )
    ...
    ping1 = getPopen(
        ndn.net["c3"],
        f"qsccp-client --prefix /C --timingStop 150000 --delayStart 60000 --tos 7 --initialSendRate 50000",
        stdout=qsccp_client_log,
        stderr=qsccp_client_log,
    )
    ping1.wait()
